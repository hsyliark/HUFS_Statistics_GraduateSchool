...
fit.ftn <- function(n.train, p) {
  ...
  KRLC
  boxplot(KRLC)
  dat1 <- data.frame(test.MR=KRLC, method=rep("KRLC",1000), number=as.character(rep(n.train,1000)))
  ...
  KRLCS
  boxplot(KRLCS)
  dat2 <- data.frame(test.MR=KRLCS, method=rep("KRLCS",1000), number=as.character(rep(n.train,1000)))
  ...
  for (s in 1:1000) {
    ...
    train.sim <- dat.gen(n.train, p, seed=s)
    test.sim <- dat.gen(1000, p, seed=s)
  ...
  KRLCB1
  boxplot(KRLCB1)
  dat3 <- data.frame(test.MR=KRLCB1, method=rep("KRLCB1",1000), number=as.character(rep(n.train,1000)))
  
  KRLCB2
  boxplot(KRLCB2)
  dat4 <- data.frame(test.MR=KRLCB2, method=rep("KRLCB2",1000), number=as.character(rep(n.train,1000)))
  
  KRLCB3
  boxplot(KRLCB3)
  dat5 <- data.frame(test.MR=KRLCB3, method=rep("KRLCB3",1000), number=as.character(rep(n.train,1000)))
  ...
  KRLCR1
  boxplot(KRLCR1)
  dat6 <- data.frame(test.MR=KRLCR1, method=rep("KRLCR1",1000), number=as.character(rep(n.train,1000)))
  
  KRLCR2
  boxplot(KRLCR2)
  dat7 <- data.frame(test.MR=KRLCR2, method=rep("KRLCR2",1000), number=as.character(rep(n.train,1000)))
  
  KRLCR3
  boxplot(KRLCR3)
  dat8 <- data.frame(test.MR=KRLCR3, method=rep("KRLCR3",1000), number=as.character(rep(n.train,1000)))
...
dat1.1 <- fit.ftn(50, 10) # Choose when n.train=50
dat1.2 <- fit.ftn(100, 10) # Choose when n.train=100
dat1.3 <- fit.ftn(200, 10) # Choose when n.train=200
dat1.4 <- fit.ftn(400, 10) # Choose when n.train=400
...
dat2.1 <- fit.ftn(50, 20) # Choose when n.train=50
dat2.2 <- fit.ftn(100, 20) # Choose when n.train=100
dat2.3 <- fit.ftn(200, 20) # Choose when n.train=200
dat2.4 <- fit.ftn(400, 20) # Choose when n.train=400
...
dat3.1 <- fit.ftn(50, 40) # Choose when n.train=50
dat3.2 <- fit.ftn(100, 40) # Choose when n.train=100
dat3.3 <- fit.ftn(200, 40) # Choose when n.train=200
dat3.4 <- fit.ftn(400, 40) # Choose when n.train=400
...
dat4.1 <- fit.ftn(50, 80) # Choose when n.train=50
dat4.2 <- fit.ftn(100, 80) # Choose when n.train=100
dat4.3 <- fit.ftn(200, 80) # Choose when n.train=200
dat4.4 <- fit.ftn(400, 80) # Choose when n.train=400
