setwd("C:/Users/user2/Desktop/석사논문 모의실험 1000")
...
method <- c(rep("m1(KRLC)",1000), rep("m2(KRLCS)",1000), rep("m3(KRLCB1)",1000), rep("m4(KRLCB2)",1000), 
            rep("m5(KRLCB3)",1000), rep("m6(KRLCR1)",1000), rep("m7(KRLCR2)",1000), rep("m8(KRLCR3)",1000))
number.50 <- c(rep("1(50)",8000))
number.100 <- c(rep("2(100)",8000))
number.200 <- c(rep("3(200)",8000))
number.400 <- c(rep("4(400)",8000))
...
dat10 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=50_p=3.txt", sep=" ")
...
dat20 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=100_p=3.txt", sep=" ")
...
dat30 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=200_p=3.txt", sep=" ")
...
dat40 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=400_p=3.txt", sep=" ")
...
dat_1 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=50_p=5.txt", sep=" ")
...
dat_2 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=100_p=5.txt", sep=" ")
...
dat_3 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=200_p=5.txt", sep=" ")
...
dat_4 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=400_p=5.txt", sep=" ")
...
dat1.1 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=50_p=10.txt", sep=" ")
...
dat1.2 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=100_p=10.txt", sep=" ")
...
dat1.3 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=200_p=10.txt", sep=" ")
...
dat1.4 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=400_p=10.txt", sep=" ")
...
dat2.1 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=50_p=20.txt", sep=" ")
...
dat2.2 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=100_p=20.txt", sep=" ")
...
dat2.3 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=200_p=20.txt", sep=" ")
...
dat2.4 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=400_p=20.txt", sep=" ")
...
dat3.1 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=50_p=40.txt", sep=" ")
...
dat3.2 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=100_p=40.txt", sep=" ")
...
dat3.3 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=200_p=40.txt", sep=" ")
...
dat3.4 <- read.table("C:/Users/user2/Desktop/석사논문 모의실험 1000/Simulation_n=400_p=40.txt", sep=" ")
