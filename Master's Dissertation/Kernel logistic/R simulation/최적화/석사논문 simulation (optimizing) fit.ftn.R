...
dat.gen5 <- function(n, beta, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1 <- runif(n,-10,10) ; x2 <- runif(n,-10,10) ; x3 <- runif(n,-10,10)
  x4 <- runif(n,-10,10) ; x5 <- runif(n,-10,10) 
  x <- cbind(1, x1, x2, x3, x4, x5)
  linpred <- x%*%beta
  p <- exp(x%*%beta) / (1+exp(x%*%beta))
  y <- apply(as.matrix(p), c(1,2), rbinom, n=1, size=1)
  dat <- data.frame(y=y, x1=x1, x2=x2, x3=x3, x4=x4, x5=x5, linpred=linpred)
  return( dat )
}
...
dat.gen20 <- function(n, beta, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1 <- runif(n,-10,10) ; x2 <- runif(n,-10,10) ; x3 <- runif(n,-10,10)
  x4 <- runif(n,-10,10) ; x5 <- runif(n,-10,10) ; x6 <- runif(n,-10,10)
  x7 <- runif(n,-10,10) ; x8 <- runif(n,-10,10) ; x9 <- runif(n,-10,10)
...
dat.gen40 <- function(n, beta, seed=NULL){
  if(!is.null(seed)) set.seed(seed)
  x1 <- runif(n,-10,10) ; x2 <- runif(n,-10,10) ; x3 <- runif(n,-10,10)
  x4 <- runif(n,-10,10) ; x5 <- runif(n,-10,10) ; x6 <- runif(n,-10,10)
  x7 <- runif(n,-10,10) ; x8 <- runif(n,-10,10) ; x9 <- runif(n,-10,10)
  ...
  x13 <- runif(n,-10,10) ; x14 <- runif(n,-10,10) ; x15 <- runif(n,-10,10)
  x16 <- runif(n,-10,10) ; x17 <- runif(n,-10,10) ; x18 <- runif(n,-10,10)
  x19 <- runif(n,-10,10) ; x20 <- runif(n,-10,10) ; x21 <- runif(n,-10,10)
  x22 <- runif(n,-10,10) ; x23 <- runif(n,-10,10) ; x24 <- runif(n,-10,10)
  x25 <- runif(n,-10,10) ; x26 <- runif(n,-10,10) ; x27 <- runif(n,-10,10)
  x28 <- runif(n,-10,10) ; x29 <- runif(n,-10,10) ; x30 <- runif(n,-10,10)
  x31 <- runif(n,-10,10) ; x32 <- runif(n,-10,10) ; x33 <- runif(n,-10,10)
  x34 <- runif(n,-10,10) ; x35 <- runif(n,-10,10) ; x36 <- runif(n,-10,10)
  x37 <- runif(n,-10,10) ; x38 <- runif(n,-10,10) ; x39 <- runif(n,-10,10)
  x40 <- runif(n,-10,10) 
  ...
  dat <- data.frame(y=y, x1=x1, x2=x2, x3=x3, x4=x4, x5=x5,
                    ...
                    x36=x36, x37=x37, x38=x38, x39=x39, x40=x40, linpred=linpred)
  return( dat )
}
...
fit.ftn <- function(n.train, p) {
  ...
  for (i in 1:100) {
    ...
    if (p==5)
    { beta <- 0.5^(0:5)
      train.sim <- dat.gen5(n.train, beta, seed=i)
      test.sim <- dat.gen5(1000, beta, seed=i)
      train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7] }    
    else if (p==10)
    { beta <- 0.5^(0:10)
      train.sim <- dat.gen10(n.train, beta, seed=i)
      test.sim <- dat.gen10(1000, beta, seed=i)
      train.sim <- train.sim[,-12] ; test.sim <- test.sim[,-12] }
    else if (p==20)
    { beta <- 0.5^(0:20)
      train.sim <- dat.gen20(n.train, beta, seed=i)
      test.sim <- dat.gen20(1000, beta, seed=i)
      train.sim <- train.sim[,-22] ; test.sim <- test.sim[,-22] }
    else if (p==40)
    { beta <- 0.5^(0:40)
      train.sim <- dat.gen40(n.train, beta, seed=i)
      test.sim <- dat.gen40(1000, beta, seed=i)
      train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42] }
  ...
  KRLC
  boxplot(KRLC)
  dat1 <- data.frame(test.MR=KRLC, method=rep("KRLC",100), number=rep(n.train,100))
  ...
  KRLCS
  boxplot(KRLCS)
  dat2 <- data.frame(test.MR=KRLCS, method=rep("KRLCS",100), number=rep(n.train,100))
  ...
  for (s in 1:100) {
    ...
    if (p==5)
    { beta <- 0.5^(0:5)
      train.sim <- dat.gen5(n.train, beta, seed=s)
      test.sim <- dat.gen5(1000, beta, seed=s)
      train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]
      test.sim.y <- test.sim[,1] }    
    else if (p==10)
    { beta <- 0.5^(0:10)
      train.sim <- dat.gen10(n.train, beta, seed=s)
      test.sim <- dat.gen10(1000, beta, seed=s)
      train.sim <- train.sim[,-12] ; test.sim <- test.sim[,-12]
      test.sim.y <- test.sim[,1] }
    else if (p==20)
    { beta <- 0.5^(0:20)
      train.sim <- dat.gen20(n.train, beta, seed=s)
      test.sim <- dat.gen20(1000, beta, seed=s)
      train.sim <- train.sim[,-22] ; test.sim <- test.sim[,-22]
      test.sim.y <- test.sim[,1] }
    else if (p==40)
    { beta <- 0.5^(0:40)
      train.sim <- dat.gen40(n.train, beta, seed=s)
      test.sim <- dat.gen40(1000, beta, seed=s)
      train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]
      test.sim.y <- test.sim[,1] }
  ...
  KRLCB1
  boxplot(KRLCB1)
  dat3 <- data.frame(test.MR=KRLCB1, method=rep("KRLCB1",100), number=rep(n.train,100))
  
  KRLCB2
  boxplot(KRLCB2)
  dat4 <- data.frame(test.MR=KRLCB2, method=rep("KRLCB2",100), number=rep(n.train,100))
  
  KRLCB3
  boxplot(KRLCB3)
  dat5 <- data.frame(test.MR=KRLCB3, method=rep("KRLCB3",100), number=rep(n.train,100))
  ...
  for (s in 1:100) {
    ...
    { beta <- 0.5^(0:5)
      ...
      train.sim.X <- train.sim[,2:6] ; test.sim.X <- test.sim[,2:6] }
    else if (p==10)
    { beta <- 0.5^(0:10)
      train.sim <- dat.gen10(n.train, beta, seed=s)
      test.sim <- dat.gen10(1000, beta, seed=s)
    ...
    { beta <- 0.5^(0:40)
      ...
      test.sim <- dat.gen40(1000, beta, seed=s)
      train.sim.y <- train.sim[,1] ; test.sim.y <- test.sim[,1]
      train.sim.X <- train.sim[,2:41] ; test.sim.X <- test.sim[,2:41] }
  ...
  KRLCR1
  boxplot(KRLCR1)
  dat6 <- data.frame(test.MR=KRLCR1, method=rep("KRLCR1",100), number=rep(n.train,100))
  
  KRLCR2
  boxplot(KRLCR2)
  dat7 <- data.frame(test.MR=KRLCR2, method=rep("KRLCR2",100), number=rep(n.train,100))
  
  KRLCR3
  boxplot(KRLCR3)
  dat8 <- data.frame(test.MR=KRLCR3, method=rep("KRLCR3",100), number=rep(n.train,100))
...
dat1.1 <- fit.ftn(50, 5) # Choose when n.train=50
dat1.2 <- fit.ftn(100, 5) # Choose when n.train=100
dat1.3 <- fit.ftn(200, 5) # Choose when n.train=200
dat1.4 <- fit.ftn(400, 5) # Choose when n.train=400

final.dat5 <- rbind(dat1.1, dat1.2, dat1.3, dat1.4)
final.dat5$number <- as.character(final.dat5$number)
...
dat2.1 <- fit.ftn(50, 10) # Choose when n.train=50
dat2.2 <- fit.ftn(100, 10) # Choose when n.train=100
dat2.3 <- fit.ftn(200, 10) # Choose when n.train=200
dat2.4 <- fit.ftn(400, 10) # Choose when n.train=400

final.dat10 <- rbind(dat2.1, dat2.2, dat2.3, dat2.4)
final.dat10$number <- as.character(final.dat10$number)
...
dat3.1 <- fit.ftn(50, 20) # Choose when n.train=50
dat3.2 <- fit.ftn(100, 20) # Choose when n.train=100
dat3.3 <- fit.ftn(200, 20) # Choose when n.train=200
dat3.4 <- fit.ftn(400, 20) # Choose when n.train=400

final.dat20 <- rbind(dat3.1, dat3.2, dat3.3, dat3.4)
final.dat20$number <- as.character(final.dat20$number)
...
dat4.1 <- fit.ftn(50, 40) # Choose when n.train=50
dat4.2 <- fit.ftn(100, 40) # Choose when n.train=100
dat4.3 <- fit.ftn(200, 40) # Choose when n.train=200
dat4.4 <- fit.ftn(400, 40) # Choose when n.train=400

final.dat40 <- rbind(dat4.1, dat4.2, dat4.3, dat4.4)
final.dat40$number <- as.character(final.dat40$number)
