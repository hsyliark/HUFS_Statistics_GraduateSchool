...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(50, beta, seed=i)
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(50, beta, seed=s)
...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(100, beta, seed=i)
  test.sim <- dat.gen5(1000, beta, seed=i)
  train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]    
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(100, beta, seed=s)
  test.sim <- dat.gen5(1000, beta, seed=s)
  train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]
  test.sim.y <- test.sim[,1]    
...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(200, beta, seed=i)
  test.sim <- dat.gen5(1000, beta, seed=i)
  train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]    
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(200, beta, seed=s)
  test.sim <- dat.gen5(1000, beta, seed=s)
  train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]
  test.sim.y <- test.sim[,1]    
...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(400, beta, seed=i)
  test.sim <- dat.gen5(1000, beta, seed=i)
  train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]    
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:5)
  train.sim <- dat.gen5(400, beta, seed=s)
  test.sim <- dat.gen5(1000, beta, seed=s)
  train.sim <- train.sim[,-7] ; test.sim <- test.sim[,-7]
  test.sim.y <- test.sim[,1]    
...
final.dat5 <- rbind(dat.res1, dat.res2, dat.res3, dat.res4)
