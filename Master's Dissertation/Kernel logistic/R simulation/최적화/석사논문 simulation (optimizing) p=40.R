...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(50, beta, seed=i)
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(50, beta, seed=s)
...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(100, beta, seed=i)
  test.sim <- dat.gen40(1000, beta, seed=i)
  train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]    
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(100, beta, seed=s)
  test.sim <- dat.gen40(1000, beta, seed=s)
  train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]
  test.sim.y <- test.sim[,1]    
...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(200, beta, seed=i)
  test.sim <- dat.gen40(1000, beta, seed=i)
  train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]    
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(200, beta, seed=s)
  test.sim <- dat.gen40(1000, beta, seed=s)
  train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]
  test.sim.y <- test.sim[,1]    
...
for (i in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(400, beta, seed=i)
  test.sim <- dat.gen40(1000, beta, seed=i)
  train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]    
...
for (s in 1:100) {
  ...
  beta <- 0.5^(0:40)
  train.sim <- dat.gen40(400, beta, seed=s)
  test.sim <- dat.gen40(1000, beta, seed=s)
  train.sim <- train.sim[,-42] ; test.sim <- test.sim[,-42]
  test.sim.y <- test.sim[,1]    
...
final.dat40 <- rbind(dat.res1, dat.res2, dat.res3, dat.res4)
