...
KRLC
boxplot(KRLC)
dat1 <- data.frame(test.MR=KRLC, method=rep("KRLC",100))
...
KRLCS
boxplot(KRLCS)
dat2 <- data.frame(test.MR=KRLCS, method=rep("KRLCS",100))
...
KRLCB1
boxplot(KRLCB1)
dat3 <- data.frame(test.MR=KRLCB1, method=rep("KRLCB1",100))

KRLCB2
boxplot(KRLCB2)
dat4 <- data.frame(test.MR=KRLCB2, method=rep("KRLCB2",100))

KRLCB3
boxplot(KRLCB3)
dat5 <- data.frame(test.MR=KRLCB3, method=rep("KRLCB3",100))
...
KRLCR1
boxplot(KRLCR1)
dat6 <- data.frame(test.MR=KRLCR1, method=rep("KRLCR1",100))

KRLCR2
boxplot(KRLCR2)
dat7 <- data.frame(test.MR=KRLCR2, method=rep("KRLCR2",100))

KRLCR3
boxplot(KRLCR3)
dat8 <- data.frame(test.MR=KRLCR3, method=rep("KRLCR3",100))  
...
final.dat <- rbind(dat1, dat2, dat3, dat4, dat5, dat6, dat7, dat8)
