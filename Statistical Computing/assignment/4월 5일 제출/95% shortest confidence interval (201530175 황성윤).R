...
G.C.I <- c((99*var(x))/qchisq(0.975, 99), (99*var(x))/qchisq(0.025, 99)) 
...
qchisq(0.975, 99) - qchisq(0.025, 99)
G.C.I[2] - G.C.I[1]
...
abline(v=qchisq(0.025, 99), col="blue") ; abline(v=qchisq(0.975, 99), col="blue")
