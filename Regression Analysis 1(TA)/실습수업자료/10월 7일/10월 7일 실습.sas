...
datafile="C:\Users\user2\Desktop\2015-2 TA\회귀분석(TA)\실습수업자료\10월 7일\COMNODE3.csv"
dbms=csv replace ;
run ;
...
* 7)  교과서 p.119  #21  Fill the blanks in ANOVA table. (See text book.) ;
...
datafile="C:\Users\user2\Desktop\2015-2 TA\회귀분석(TA)\실습수업자료\10월 7일\ABXSALES3.csv"
dbms=csv replace ;
run ;
