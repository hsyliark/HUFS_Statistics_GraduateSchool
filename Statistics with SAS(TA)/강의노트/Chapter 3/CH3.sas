...
PROC EXPORT
     DATA=admit1
     OUTFILE='C:\Users\ADMIN\Copy\HUFS\lecture\2016-1 SASstat\exer.dat' 
     DBMS=DLM
     REPLACE;
RUN;
...
data _null_;
	set clinic.stress;
	file 'C:\Users\ADMIN\Copy\HUFS\lecture\2016-1 SASstat\stress.dat';
	put ID 1-4 Name $ 6-25 RestHR 27-29 MaxHR 31-33 RecHR 35-37 TimeMin 39-40 TimeSec 42-43 Tolerance $ 45;
run;
